...
class TrackHeaderItem(QGraphicsItem):
    ...
    def boundingRect(self) -> QRectF:
        # LEFT_MARGIN × (height × v_zoom) # :Future: v_zoom
        return QRectF(
            0, 0,
